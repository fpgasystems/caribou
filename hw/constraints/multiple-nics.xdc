...
#set_property PACKAGE_PIN AM4 [get_ports xphy1_txp]
#set_property PACKAGE_PIN AM3 [get_ports xphy1_txn]
#set_property PACKAGE_PIN AL6 [get_ports xphy1_rxp]
#set_property PACKAGE_PIN AL5 [get_ports xphy1_rxn]
##
#set_property PACKAGE_PIN AL2 [get_ports xphy2_txp]
#set_property PACKAGE_PIN AL1 [get_ports xphy2_txn]
#set_property PACKAGE_PIN AJ6 [get_ports xphy2_rxp]
#set_property PACKAGE_PIN AJ5 [get_ports xphy2_rxn]


#for facade and backend
...
#create_clock -period 6.400 -name MGTREFCLK [get_ports MGTREFCLK_P]

#set_property PACKAGE_PIN E10 [get_ports MGTREFCLK_P]
#set_property PACKAGE_PIN E9 [get_ports MGTREFCLK_N]


#set_property PACKAGE_PIN C2 [get_ports sata1_tx_p]
#set_property PACKAGE_PIN C1 [get_ports sata1_tx_n]
